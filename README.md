...
```shell
git clone https://github.com/Krigs-hund/zu_im
```
...
4) Build a local version of your site by executing `hugo server` at the root of the repository. You can see the site by navigating to `http://localhost:1313/zu_im/` (actual URL will be outputted in the CLI) in a browser.
...
`https://Krigs-hund.github.io/zu_im`